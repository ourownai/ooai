/*
 * Original file path: https://github.com/hasura/graphql-engine/blob/master/frontend/libs/console/legacy-ce/src/lib/features/Actions/components/OASGenerator/utils.ts
 */
...
import {buildClientSchema, getIntrospectionQuery, graphqlSync, printSchema,} from 'graphql';
import {createGraphQLSchema, GraphQLOperationType, Oas2, Oas3,} from 'openapi-to-graphql';
import {Microfiber} from 'microfiber';
import {formatSdl} from 'format-graphql';
import {getActionRequestSampleInput} from './add/utils.js';
